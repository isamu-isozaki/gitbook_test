...
Please see our [social media guidelines](https://github.com/daijapan/test/tree/master/marketing/social-media-guidelines/index.html.md/index.html.md).
...
1. Use the public issue trackers on GitLab.com for everything since [we work out in the open](/2015/08/03/almost-everything-we-do-is-now-open/index.html.md/index.html.md). Issue trackers that can be found on the relevant page in the handbook and in the projects under [the gitlab-com group](https://gitlab.com/gitlab-com/index.html.md/index.html.md).
...
1. Even when something is not done, share it internally so people can comment
  ...
  Progress](/2016/01/08/feature-highlight-wip/index.html.md/index.html.md)** merge request so it is not merged by accident.
...
1. We prefer [Zoom](https://gitlab.zoom.us/index.html.md/index.html.md).
...
1. Guide users who ask for help or give a suggestion and share links. [Improving Open Development for Everyone](/2015/12/16/improving-open-development-for-everyone/index.html.md/index.html.md), [Types of requests](/2014/12/08/explaining-gitlab-bugs/index.html.md/index.html.md).
1. When facing negative comment, respond patiently and treat every user as an individual, people with the strongest opinions can turn into [the strongest supporters](/2015/05/20/gitlab-gitorious-free-software/index.html.md/index.html.md).
...
1. Use [inclusive and gender-neutral language](https://techwhirl.com/gender-neutral-technical-writing/index.html.md/index.html.md) in all writing.
...
By having ubiquitous words to identify concepts we prevent confusion over what is meant, for example we refer to [parts of our organization](/team/structure/index.html.md/index.html.md) as a function, department, or group depending on exactly what is meant.
...
1. Log in to the [Zoom](https://zoom.us/index.html.md/index.html.md) account of the meeting and go to the menu on the right and choose "My Recordings" (it can take up to 30 minutes before the recording is available to be shared/index.html.md).
