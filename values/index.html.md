...
1. **Blameless problem solving** Investigate mistakes in a way that focuses on the situational aspects of a failure’s mechanism and the decision-making process that led to the failure rather than cast blame on a person or team. We hold blameless [post-mortems](https://codeascraft.com/2012/05/22/blameless-postmortems/index.html.md/index.html.md) and [retrospectives](handbook/engineering/management/team-retrospectives/index.html.md/index.html.md) for stakeholders to speak up without fear of punishment or retribution.
...
1. **Write promises down** Agree in writing on measurable goals. Within the company we use [public OKRs](/okrs/index.html.md/index.html.md) for that.
...
1. **ConvDev** We work according to the principles of [conversational development](http://conversationaldevelopment.com/index.html.md/index.html.md).
...
The community consists of people from all over the world, with different backgrounds and opinions. We hire globally and encourage hiring in a diverse set of countries. We work to make everyone feel welcome and to increase the participation of underrepresented minorities and nationalities in our community and company. For example our sponsorship of [diversity events](/2016/03/24/sponsorship-update/index.html.md/index.html.md) and a [double referral bonus](https://github.com/daijapan/test/tree/master/incentives/#referral-bonuses/index.html.md).
...
1. **Inclusive language** In our [general guidelines](https://github.com/daijapan/test/tree/master/general-guidelines/index.html.md/index.html.md) we list: 'Use inclusive language. For example, prefer "Hi everybody" or "Hi people" to "Hi guys".'
1. **Inclusive interviewing** As part of our [interviewing process](https://github.com/daijapan/test/tree/master/hiring/interviewing/index.html.md/index.html.md) we list: "The candidate should be interviewed by at least one female GitLab team member."
...
1. **Reduce cycle time** Short iterations reduce [our cycle time](/features/cycle-analytics/index.html.md/index.html.md).
...
1. **Don't wait for a two way door** Most decisions are easy to reverse, have the [directly responsible individual](https://github.com/daijapan/test/tree/master/people-operations/directly-responsible-individuals/index.html.md/index.html.md) make them without approval. As [Jeff Bezos describes](http://minimumviablestrategy.com/lessons/leadership/one-way-and-two-way-door-decisions/index.html.md/index.html.md) only when you can't reverse them there should be a decision process.
...
1. **Disagree and commit** Everything can be questioned but as long as a decision is in place we expect people to commit to executing it, which is [a common principle](http://ryanestis.com/leadership/disagree-and-commit-to-get-things-done/index.html.md/index.html.md).
...
Our values are updated continually when needed. Everyone is welcome to make a suggestion to improve them. To update: make a merge request and assign it to the CEO. If you're a [team member](/team/index.html.md/index.html.md) or in the [core team](/core-team/index.html.md/index.html.md) please post a link to the MR in the #values channel. If you're not part of those groups please send a direct Twitter message to [@sytses](https://twitter.com/sytses/index.html.md).
...
During every [GitLab 101 session with new hires](/culture/gitlab-101/index.html.md/index.html.md) we discuss our values. We document the questions and answers to [Frequently Asked Questions about the GitLab Culture](/culture/gitlab-101/#frequently-asked-questions-about-the-gitlab-culture/index.html.md).
