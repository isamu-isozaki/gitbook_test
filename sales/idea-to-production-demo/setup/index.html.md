...
test box for demonstrating our Idea to Production [demo](https://github.com/daijapan/test/tree/master/sales/idea-to-production-demo/index.html.md/index.html.md).
...
The rest of the demo process can be mostly followed from the [Demo Script](https://github.com/daijapan/test/tree/master/sales/idea-to-production-demo/index.html.md/index.html.md)
