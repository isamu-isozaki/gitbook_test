...
GitLab is committed to serving our customers and employing individuals with personal standards consistent with that of our [values](https://github.com/daijapan/test/tree/master/values/index.html.md/index.html.md). This Code is designed to deter wrongdoing and to promote:
...
All employees and contractors must protect our [company assets](https://github.com/daijapan/test/tree/master/spending-company-money/index.html.md/index.html.md), such as equipment, inventory, supplies, cash, and information. Treat company assets with the same care you would if they were your own. No employee or contractor may commit theft, fraud or embezzlement, or misuse company property.
...
If you do not have a business reason to access this information, you should not do so. If you do, you must also take steps to protect the information against unauthorized use or release in line with our [Security Best Practices](https://github.com/daijapan/test/tree/master/security/index.html.md/index.html.md).
...
* The WHO [defines mental health](http://www.who.int/features/factfiles/mental_health/en/index.html.md/index.html.md) as:
...
1. Why is awareness of Mental Health important at GitLab?
  * It can affect any and all of us.  The statistics from the WHO are that [1 in 4](http://www.who.int/whr/2001/media_centre/press_release/en/index.html.md/index.html.md) of us will be affected by mental or neurological disorders at some point in our life.  That said, we are all subject to periods where we or those around us find the "the normal stresses of life" harder than usual to deal with.
...
* [360 Feedback](https://github.com/daijapan/test/tree/master/people-operations/360-feedback/index.html.md/index.html.md)
...
* [Paid Time Off](https://github.com/daijapan/test/tree/master/paid-time-off/index.html.md/index.html.md)
