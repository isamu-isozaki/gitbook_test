...
1. Under `Lists` create a new lists titled "Responsibilities" and "Requirements"
  ...
  * Ensure the language and structure is gender neutral using this [gender decoder](http://gender-decoder.katmatfield.com/index.html.md/index.html.md). Make necessary edits to the vacancy description, and create a merge request to update the position description.
...
1. [LinkedIn](https://www.linkedin.com/index.html.md/index.html.md) (Able to post 3 vacancies simultaneously, please mention to employment team if you want your role listed here/index.html.md)
...
1. [TechLadies](https://www.hiretechladies.com/index.html.md/index.html.md) (Able to post 4 roles simultaneously, please mention to employment team if you want your role listed here; at this time we are not posting engineering roles to TechLadies/index.html.md)
1. [PowerToFly](https://powertofly.com/index.html.md/index.html.md) (All current vacancies are updated biweekly/index.html.md)
1. [RemoteBase](https://remotebase.io/index.html.md/index.html.md) (Free; position descriptions are synced directly to our respective position description sites/index.html.md)
...
1. [Indeed Prime](http://www.indeed.com/index.html.md/index.html.md) (Primarily used for non-engineering roles/index.html.md)
