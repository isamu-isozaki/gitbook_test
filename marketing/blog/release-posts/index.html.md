...
the [markdown guide](https://github.com/daijapan/test/tree/master/product/technical-writing/markdown-guide/index.html.md/index.html.md).
...
All `description` fields fully support [markdown](https://github.com/daijapan/test/tree/master/product/technical-writing/markdown-guide/index.html.md/index.html.md), the only thing you need to be worried about is respecting the indentation.
...
For entries that support markdown, use regular [markdown Kramdown](https://github.com/daijapan/test/tree/master/product/technical-writing/markdown-guide/index.html.md/index.html.md), as we use for all blog posts and webpages on about.GitLab.com.
