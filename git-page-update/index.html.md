...
- People that have been here longer than 3 months, the [team page](/team/index.html.md/index.html.md) lists people in order of how long they have been here.
...
1. For more information about using Git and GitLab see [GitLab University](https://docs.gitlab.com/ee/university/index.html.md/index.html.md).
...
1. Visit [https://rvm.io](https://rvm.io/index.html.md/index.html.md).
...
1. Execute: `gem install bundler` to install [Bundler](http://bundler.io/index.html.md/index.html.md).
...
1. Visit [http://localhost:4567/](http://localhost:4567/index.html.md/index.html.md) in your browser.
1. You will need to install a text editor to edit the site locally. We recommend
   [Sublime Text 3](http://www.sublimetext.com/3/index.html.md) or [Atom](https://atom.io/index.html.md/index.html.md). Use command / ctrl P to quickly open the file you need.
...
1. Install the [check-my-links](https://chrome.google.com/webstore/detail/check-my-links/ojkcdipcgfaekbeaelaapakgnjflfglf/index.html.md/index.html.md) extension in Chrome (no other browsers
...
Most pages that you might want to edit are written in markdown [Kramdown](http://kramdown.gettalong.org/index.html.md/index.html.md).
Read through our [Markdown Guide](https://github.com/daijapan/test/tree/master/product/technical-writing/markdown-guide/index.html.md/index.html.md) to understand its syntax and create new content.
...
We are happy to have you join our company and to include you in our [team page](/team/index.html.md/index.html.md). Please follow the instructions and links below that will guide you through each step. There are instructions for both the web interface and locally, depending on your familiarity with git. Feel free to ask anyone at the company questions along the way.
...
### Add on GitLab.com (Web IDE/index.html.md)
  ...
  2.  Find the picture that you'd like to add to our team page, change the picture's name to the following format: `yournameinlowercase.jpg` or `yournameinlowercase.png`. (There should be no space between first and last names e.g. firstlast.jpg or firstlast.png/index.html.md) Ensure the picture size is around 400x400 (*it must be square*/index.html.md) and the format is JPEG or PNG. You can resize your picture using a photo editor like [GIMP](http://www.gimp.org/index.html.md/index.html.md) (cross-platform/index.html.md) or online by searching for "image resize". Any picture that you provide will be made black-and-white automatically after you add it to the team page.
  3. Go to the [GitLab.com / www-gitlab-com](https://gitlab.com/gitlab-com/www-gitlab-com/index.html.md/index.html.md) project.
...
### Add on GitLab.com (web interface/index.html.md)
  ...
  1. You should have received an invitation to the [www-gitLab-com project](https://gitlab.com/gitlab-com/www-gitlab-com/index.html.md) at your GitLab email account. After creating your account, take note of your username and password, because you will need them throughout these steps.
  2.  Find the picture that you'd like to add to our team page, change the picture's name to the following format: `yournameinlowercase.jpg` or `yournameinlowercase.png`. (There should be no space between first and last names e.g. firstlast.jpg or firstlast.png/index.html.md) Ensure the picture size is around 400x400 (*it must be square*/index.html.md) and the format is JPEG or PNG. You can resize your picture using a photo editor like [GIMP](http://www.gimp.org/index.html.md/index.html.md) (cross-platform/index.html.md) or online by searching for "image resize". Any picture that you provide will be made black-and-white automatically after you add it to the team page.
  3. In [GitLab.com](https://gitlab.com/index.html.md/index.html.md), select the GitLab.com/www-gitlab-com project.
  ...
  8. [Create a merge request](https://docs.gitlab.com/ee/gitlab-basics/add-merge-request.html/index.html.md) in [GitLab.com](https://gitlab.com/index.html.md/index.html.md) with the branch that you created with your picture.
...
### Add Locally (using the terminal/index.html.md)
  ...
  13. [Create a Merge Request](https://docs.gitlab.com/ee/gitlab-basics/add-merge-request.html/index.html.md) in [GitLab.com](https://gitlab.com/index.html.md/index.html.md) with the branch that you created. Assign it to People Ops for review (the recommended assignee would be the Talent Operations Specialist who helped you with onboarding/index.html.md).

### Add your pet(s/index.html.md) to the Team Pets Page

  Using what you learned in the [steps above](git-pages-update/#11-add-yourself-to-the-team-page/index.html.md), consider adding your pet to the [Team Pets page](https://about.gitlab.com/team-pets/index.html.md/index.html.md). You can follow these instructions for adding them via the Web IDE.
  ...
  1. Go to the [GitLab.com / www-gitlab-com](https://gitlab.com/gitlab-com/www-gitlab-com/index.html.md/index.html.md) project.
...
1. Edit the page using [MarkDown](https://github.com/daijapan/test/tree/master/product/technical-writing/markdown-guide/index.html.md/index.html.md). You can preview your changes (but links will not work/index.html.md).
...
1. **[handbook](https://github.com/daijapan/test/tree/masterhttps://github.com/daijapan/test/tree/master-usage/index.html.md/index.html.md)**: The handbook is for any content that needs to be [used by GitLabbers to do thier job](https://about.gitlab.comhttps://github.com/daijapan/test/tree/masterhttps://github.com/daijapan/test/tree/master-usage/index.html.md/index.html.md). If you put content on the blog, website, and docs, but you think it would be helpful for GitLabbers to do thier job then link to the content from the handbook.  
