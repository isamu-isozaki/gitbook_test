...
Achieving ours goals requires a high-performance team that adheres to [**GitLab's values**](https://github.com/daijapan/test/tree/master/values/index.html.md/index.html.md).
...
* Focus on **observable availability** at every turn and watch each other's back. Read and embrace Richard Cook’s
  ...
  * Adopt a **[Change Management mindset](https://github.com/daijapan/test/tree/master/engineering/infrastructure/change-management/index.html.md/index.html.md)**: evaluate risk, plan accordingly, protect the environment
